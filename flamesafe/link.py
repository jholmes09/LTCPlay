...
def decode_flame(data, expect_universe):
...
def encode_flame(seq, timecode, mono, universe, values):
    ...
    return json.dumps({
        "v": CONTRACT_VERSION, "t": "flame", "seq": int(seq),
...
def encode_status(status):
    """The status frame, as bytes for the wire."""
